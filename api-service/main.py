...
WORKFLOW_NAME = "promptflow-orchestrator"
...
async def create_job(config: JobConfig):
    ...
    job_data = {
        ...
        "config": {
            ...
            "parentPrompts": config.parent_prompts # Save parent
        },
...
async def get_job_status(job_id: str):
    ...
    # Get the Results (Prompts & Scores)
    ...
    response = {
        ...
        "results": results_list # list of generated prompts and scores
    }
